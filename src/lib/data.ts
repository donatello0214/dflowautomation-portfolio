...
export const projects: Project[] = [
  ...
  },
  {
    ...
    overview: 'This end-to-end pipeline automates content creation, from idea generation in Airtable to final publication on a Webflow blog, using AI for drafting and image selection, managed by Zapier.',
    problem: 'The client\'s content creation process was slow and manual, involving multiple handoffs between strategists, writers, and editors, which resulted in a lengthy two-week lifecycle for each article.',
    solution: 'A Zapier workflow was built to trigger AI content generation from Airtable outlines. Approved drafts were automatically enhanced with SEO-optimized images and meta tags before being published to Webflow.',
    impact: 'This automated system dramatically reduced the average content lifecycle from two weeks to just two days, freeing up the content team to focus on strategy and quality rather than manual coordination.',
  ...
  },
  {
    ...
    overview: 'A multi-step Zapier workflow that automates the entire new hire onboarding process, from creating user accounts in G-Suite and Slack to enrolling them in training courses and sending welcome emails.',
    problem: 'The HR department spent excessive manual effort on repetitive onboarding tasks for each new employee, leading to inconsistencies, delays, and a poor initial experience for new hires.',
