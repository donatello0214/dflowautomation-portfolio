  ...
  return (
    ...
    >
      <div className="container relative z-10 flex flex-col items-center">
        <h1 className="font-headline text-4xl font-black tracking-tighter text-white drop-shadow-lg dark:text-white dark:drop-shadow-[0_2px_10px_rgba(119,188,255,0.5)] sm:text-6xl md:text-7xl lg:text-8xl">
