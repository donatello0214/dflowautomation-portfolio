  ...
  return (
    <>
      <Dialog open={isModalOpen} onOpenChange={onModalOpenChange}>
        ...
        <DialogContent className="flex max-h-[90vh] max-w-3xl flex-col border-accent/20 bg-background/80 shadow-lg shadow-accent/20 backdrop-blur-lg sm:rounded-lg">
          <DialogHeader>
            <div
          ...
          <ScrollArea className="flex-1 pr-4 -mr-4 overflow-y-scroll">
      ...
      <Dialog open={isZoomed} onOpenChange={onZoomOpenChange}>
        ...
        >
          ...
          <div 
            className="relative h-full w-full flex items-center justify-center cursor-zoom-out"
            onClick={() => onZoomOpenChange(false)}
          >
            <Image
              src={currentImage.imageUrl}
